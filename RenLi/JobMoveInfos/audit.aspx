<%@ Page Language="C#" AutoEventWireup="true" CodeFile="audit.aspx.cs" Inherits="JobMoveInfos_audit" %>
            ...
            <td>
                <table class="customer">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlNewJob" runat="server" Enabled="False">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtRemark" runat="server" Width="600px" Enabled="False"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class='alt'>
