<%@ Page Language="C#" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="RecruitInfos_list" %>
            ...
            <td>
                <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ShenQingRen" HeaderText="申请人" SortExpression="ShenQingRen" ItemStyle-HorizontalAlign="Center" />
