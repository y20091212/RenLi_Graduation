<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userlist.aspx.cs" Inherits="RewardsInfos_userlist" %>
        ...
        <tr>
            <td>
                <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"
                    ...
                    <Columns>
                        <asp:BoundField DataField="JiannCheng" HeaderText="JiannCheng" SortExpression="JiannCheng"
                        ...
                        <asp:BoundField DataField="UserName" HeaderText="UserName" SortExpression="UserName"
                            ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="LuRuUserName" HeaderText="LuRuUserName" SortExpression="LuRuUserName"
                            ItemStyle-HorizontalAlign="Center" />
