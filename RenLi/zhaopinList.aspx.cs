...
public partial class zhaopinList : System.Web.UI.Page
{
    ...
    public void BindData()
    {
        ...
        { //style='color:green'
            ...
            else if (info.Allow == 3)
            {
                info.Status = "<spna style='color:blue'>招聘完成</span>";
            }
            else
            {
    ...
    public DataSet GetList(string strWhere)
    {
        ...
        strSql.Append(" where Allow = 1 or allow=3");
