...
public partial class JingGao_departlist : System.Web.UI.Page
{
    ...
    public void BindData()
    {
        ...
        {
            int jinggaoCiShu = GetChiDaoZaoTuiCount(info.ID, dateTime);
            info.Salary = jinggaoCiShu;
            if (jinggaoCiShu > 0 && jinggaoCiShu < 3)
            {
                info.Status = "<span style='color:green'>警告</span>";
            }
            else if (jinggaoCiShu > 0 && jinggaoCiShu < 6)
            {
                info.Status = "<span style='color:blue'>特殊警告</span>";
            }
            else if (jinggaoCiShu > 0 && jinggaoCiShu < 10)
            {
                info.Status = "<span style='color:red'>严重警告</span>";
            }
            else
            {
                info.Status = "<span>正常</span>";
            }
        }
    ...
    public int GetChiDaoZaoTuiCount(int userid, DateTime time)
    {
    ...
    public DataSet GetList(string strWhere)
    {
        ...
        strSql.Append(" where Department = " + Session["departid"]);
        if (strWhere.Trim() != "")
        {
